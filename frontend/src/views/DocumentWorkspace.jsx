...
export default function DocumentWorkspace() {
  ...
  return (
    // FIX 1: Changed to flex-col and items-center to force strict center alignment
    <div className="flex flex-col items-center w-full overflow-hidden h-[calc(100vh-3.5rem)] bg-gray-50">
      
      {/* FIX 2: Added mx-auto here to guarantee equal margins on left and right */}
      <div className="w-full max-w-7xl h-full bg-white flex flex-col relative shadow-lg border-x border-gray-200 mx-auto">
        ...
        {/* Top Navigation Bar */}
        <div className="px-8 pt-6 pb-0 bg-white border-b border-gray-200 shrink-0 flex justify-between items-end">
          ...
          {activeTab !== 'PIPELINE' && (
            <div className="pb-3 relative ml-4 shrink-0">
              ...
              <input 
                ...
                className="pl-9 pr-3 py-1.5 text-sm bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 w-48 transition-all"
              />
            </div>
          )}
        </div>
